...
export default class SuperDao implements ISuperDao {
    ...
    public async findAllByWhere(
        where: object,
        attributes: string[] | object | null = null,
    ...
    public async findOneByWhere(
        ...
        const timezone = getTimezoneVariable();
    ...
    public async findOneByWhereForPdfGenerate(
        where: object,
        attributes: string[] | object | null = null,
        order: string[] = ['id', 'desc']
    ): Promise<any> {
    ...
    public async updateOrCreate(where: object, defaults: object): Promise<any> {
        return this.Model.findOrCreate({ where, defaults })
            .then(async ([result, created]) => {
                if (!created) {
                    await this.Model.update(defaults, { where });
                }
